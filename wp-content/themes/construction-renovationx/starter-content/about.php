...
return array(
	'post_type'    => 'page',
	'post_title'   => _x( 'About', 'Theme starter content', 'construction-renovationx' ),
	...
	<h2 class="alignwide has-background-color has-text-color has-extra-huge-font-size">About Us</h2>
	<!-- /wp:heading -->
	...
	<p class="has-text-color has-medium-font-size" style="color:#d1d1d1">About Us</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:group --></div>
	<!-- /wp:group --></div>
	<!-- /wp:group --></div></div>
